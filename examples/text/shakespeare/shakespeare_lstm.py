...
text = open('../../../datasets/text/tinyshakespeare.txt').read().lower()
...
plot_metric('accuracy', model_epochs, fit_stats['train_acc'], fit_stats['valid_acc'], model_name = model_names)
